...
- Engine failures do not automatically retry; they update the unavailable status rather than reporting a clean review. Manual retry is available below.
...
Use Python 3.11+ and an authenticated local Codex CLI. A dedicated virtualenv is recommended.
